...
const I18N = {
  fr: {
    ...
    about: "À propos", aboutTitle: "À propos de cette app",
    aboutCreator: "Conçu et développé par", aboutContrib: "avec l'assistance de l'IA (GitHub Copilot).",
    aboutLicenseLabel: "Code et contenu original sous licence",
    aboutLicenseDesc: "Vous pouvez partager et adapter l'app à des fins non commerciales, en créditant l'auteur et en partageant sous la même licence.",
    aboutUnofficial: "Outil non officiel. « Blood on the Clocktower » est une création de The Pandemonium Institute : aucun texte ni illustration officiels ne sont inclus, les capacités sont reformulées et les emblèmes générés par l'app.",
    aboutSource: "Code source", aboutVersion: "Version",
  ...
  en: {
    ...
    about: "About", aboutTitle: "About this app",
    aboutCreator: "Designed and developed by", aboutContrib: "with AI assistance (GitHub Copilot).",
    aboutLicenseLabel: "Original code and content licensed under",
    aboutLicenseDesc: "You may share and adapt the app for non-commercial purposes, crediting the author and sharing under the same licence.",
    aboutUnofficial: "Unofficial tool. \u201CBlood on the Clocktower\u201D is created by The Pandemonium Institute: no official text or artwork is included, abilities are reworded and emblems are generated by the app.",
    aboutSource: "Source code", aboutVersion: "Version",
...
function openSettings() {
  ...
  openModal(`
    ...
    <div class="row" style="margin-top:8px">
      ...
      <button class="btn small ghost" id="set-about">ℹ️ ${t("about")}</button>
    </div>
    <div class="row" style="margin-top:8px">
...
function openAbout() {
  const ccUrl = "https://creativecommons.org/licenses/by-nc-sa/4.0/deed" + (S.lang === "fr" ? ".fr" : ".en");
  openModal(`
    <button class="close-x" onclick="closeModal()">×</button>
    <h3>ℹ️ ${t("aboutTitle")}</h3>
    <div class="about-box">
      <p class="about-app">🕰️ <b>${t("appName")}</b></p>
      <p>${t("aboutCreator")} <b>Sébastien Place</b> (<a href="https://github.com/sebplace" target="_blank" rel="noopener">@sebplace</a>) ${t("aboutContrib")}</p>
      <p class="about-lic">📜 ${t("aboutLicenseLabel")} <a href="${ccUrl}" target="_blank" rel="noopener"><b>Creative Commons BY-NC-SA 4.0</b></a>.<br>
        <span class="muted">${t("aboutLicenseDesc")}</span></p>
      <p class="about-cc">CC BY-NC-SA 4.0 &nbsp;·&nbsp; © 2026 Sébastien Place</p>
      <p class="about-warn">⚠️ ${t("aboutUnofficial")}</p>
      <p class="muted">🔗 ${t("aboutSource")} : <a href="https://github.com/sebplace/grimoire-du-conteur" target="_blank" rel="noopener">github.com/sebplace/grimoire-du-conteur</a></p>
    </div>
    <div class="modal-actions"><button class="btn gold" onclick="closeModal()">${t("close")}</button></div>
  `);
}
